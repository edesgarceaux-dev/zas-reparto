...
class _EntregaPruebaScreenState extends State<EntregaPruebaScreen> {
  ...
  Future<void> _tomarFoto(String slot) async {
    try {
      // v2.9 — la foto es una PRUEBA DE ENTREGA, no una postal: tiene que
      // dejar leer el número de la casa y reconocer a quien recibe, nada
      // más. A 900px calidad 45 pesa ~70 KB en vez de ~180 KB, o sea que
      // el almacenamiento del servidor rinde casi el triple. A 258 pedidos
      // por día eso es pasar de 4,2 GB al mes a 1,6 GB.
