          ...
          child: ListView(
            ...
            children: [
              ...
              OutlinedButton.icon(
                ...
                label: const Text('Escanear etiquetas QR de los bultos'),
                onPressed: () async {
                  final res = await Navigator.push<Set<int>>(
                    context,
                    MaterialPageRoute(
                        builder: (_) => EscanerCargaScreen(
                            pedidos: activos, validados: _validados)),
                  );
                  if (res != null && mounted) {
                    setState(() {
                      _validados
