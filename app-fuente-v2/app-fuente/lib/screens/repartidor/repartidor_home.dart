...
class _RepartidorHomeState extends State<RepartidorHome> {
  ...
  Future<void> _cargarPrefBio() async {
    final prefs = await SharedPreferences.getInstance();
    if (mounted) {
      setState(() => _bioActiva = prefs.getBool('bio_activa') ?? false);
    }
    // ofrecer huella la primera vez
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
                'Cada vez que abras ZAS Reparto se pedirá tu huella (o el desbloqueo de tu teléfono). Puedes cambiarlo después en el menú.',
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(activar
              ? '🔒 Huella activada: se pedirá al abrir la app'
              : 'Huella desactivada')));
    }
  }
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text('Hola, ${widget.perfil['nombre'].toString().split(' ').first} 👋',
                      style: const TextStyle(
                          fontSize: 18, fontWeight: FontWeight.w800),
                      overflow: TextOverflow.ellipsis),
                  Text('Tus repartos de hoy',
                      style: TextStyle(
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (_) => [
              PopupMenuItem(
                value: 'bio',
                child: Row(children: [
                  Icon(_bioActiva ? Icons.fingerprint_outlined : Icons.fingerprint,
                      color: naranjaZas),
